...
for page in range(1, 1000):
    ...
    url = f"https://webapi.acfun.cn/query/article/list?" \
          f"pageNo={page}&size=10&realmIds=5%2C22%2C3%2C4&originalOnly=" \
          f"false&orderType=2&periodType=-1&filterTitleImage=true"
